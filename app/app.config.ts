  ...
  ui: {
    ...
    table: {
      slots: {
        ...
        tfoot: 'relative',
        tr: 'data-[selected=true]:bg-elevated/50 header-line',
        th: 'th-classic px-4 py-3.5 text-sm text-highlighted text-left rtl:text-right font-semibold [&:has([role=checkbox])]:pe-0',
